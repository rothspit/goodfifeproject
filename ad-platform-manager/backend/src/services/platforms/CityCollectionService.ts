...
export class CityCollectionService extends BaseAdPlatformService {
  protected BASE_URL = 'https://city-collection.net/admin/';
  protected LOGIN_URL = 'https://city-collection.net/admin/login';
  protected PLATFORM_NAME = 'シティコレクション';
