...
export class QpriService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.qpri.jp/admin/';
  protected LOGIN_URL = 'https://www.qpri.jp/admin/login';
  protected PLATFORM_NAME = 'Qプリ';
