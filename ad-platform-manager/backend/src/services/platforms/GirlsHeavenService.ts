...
export class GirlsHeavenService extends BaseAdPlatformService {
  protected BASE_URL = 'https://girls-heaven.jp/admin/';
  protected LOGIN_URL = 'https://girls-heaven.jp/admin/login';
  protected PLATFORM_NAME = 'ガールズヘブンネット';
