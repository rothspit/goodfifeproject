...
export class TeleClubService extends BaseAdPlatformService {
  protected BASE_URL = 'https://tele-club.net/admin/';
  protected LOGIN_URL = 'https://tele-club.net/admin/login';
  protected PLATFORM_NAME = '風俗テレクラ情報';
