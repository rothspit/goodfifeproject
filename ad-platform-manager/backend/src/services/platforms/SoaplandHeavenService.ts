...
interface SoaplandHeavenCredentials {
  username: string;
  password: string;
}
...
export class SoaplandHeavenService {
  private browser: Browser | null = null;
  private context: BrowserContext | null = null;
  private page: Page | null = null;
  private isLoggedIn: boolean = false;
  
  private readonly BASE_URL = 'https://www.soapheaven.jp/admin/';
  private readonly LOGIN_URL = 'https://www.soapheaven.jp/admin/login.php';
   ...
   * ログイン処理
   */
  async login(credentials: SoaplandHeavenCredentials): Promise<boolean> {
    try {
