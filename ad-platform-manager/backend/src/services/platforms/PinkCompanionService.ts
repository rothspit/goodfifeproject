...
export class PinkCompanionService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.pinkcompanion.com/admin/';
  protected LOGIN_URL = 'https://www.pinkcompanion.com/admin/login';
  protected PLATFORM_NAME = 'ピンクコンパニオン';
