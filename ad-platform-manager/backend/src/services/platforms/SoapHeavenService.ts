...
export class SoapHeavenService {
  ...
  // ソープランドヘブンの管理画面URL
  private readonly BASE_URL = 'https://soap.cityheaven.net/';
  private readonly MANAGER_URL = 'https://spmanager.cityheaven.net/'; // シティヘブンと共通の可能性
   ...
   */
  async login(credentials: SoapHeavenCredentials): Promise<boolean> {
    try {
...
export const soapHeavenService = new SoapHeavenService();
