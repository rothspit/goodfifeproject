...
export class EkichikaService extends BaseAdPlatformService {
  protected BASE_URL = 'https://ekichika.jp/admin/';
  protected LOGIN_URL = 'https://ekichika.jp/admin/login';
  protected PLATFORM_NAME = '駅ちか';
