...
export class JukujoStyleService extends BaseAdPlatformService {
  protected BASE_URL = 'https://jukujo-style.jp/admin/';
  protected LOGIN_URL = 'https://jukujo-style.jp/admin/login';
  protected PLATFORM_NAME = '熟女Style';
