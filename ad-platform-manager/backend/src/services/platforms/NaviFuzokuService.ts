...
export class NaviFuzokuService extends BaseAdPlatformService {
  protected BASE_URL = 'https://navi-fuzoku.com/admin/';
  protected LOGIN_URL = 'https://navi-fuzoku.com/admin/login';
  protected PLATFORM_NAME = 'Navi Fuzoku';
