...
export class DeliGetService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.deli-get.com/admin/';
  protected LOGIN_URL = 'https://www.deli-get.com/admin/login';
  protected PLATFORM_NAME = 'デリゲット';
