...
export class IchigekiService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.ichigeki.jp/admin/';
  protected LOGIN_URL = 'https://www.ichigeki.jp/admin/login';
  protected PLATFORM_NAME = '一撃';
