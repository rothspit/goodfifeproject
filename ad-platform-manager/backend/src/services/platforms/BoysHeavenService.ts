...
export class BoysHeavenService extends BaseAdPlatformService {
  protected BASE_URL = 'https://boys-heaven.jp/admin/';
  protected LOGIN_URL = 'https://boys-heaven.jp/admin/login';
  protected PLATFORM_NAME = 'ボーイズヘブンネット';
