...
export class PinsaroService extends BaseAdPlatformService {
  protected BASE_URL = 'https://pinsaro.com/admin/';
  protected LOGIN_URL = 'https://pinsaro.com/admin/login';
  protected PLATFORM_NAME = 'ピンサロドットコム';
