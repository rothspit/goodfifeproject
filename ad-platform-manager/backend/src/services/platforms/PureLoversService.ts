...
export class PureLoversService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.purelovers.com/admin/';
  protected LOGIN_URL = 'https://www.purelovers.com/admin/login';
  protected PLATFORM_NAME = 'ぴゅあらば';
