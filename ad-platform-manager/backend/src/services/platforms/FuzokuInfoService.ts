...
export class FuzokuInfoService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.fuzoku.jp/admin/';
  protected LOGIN_URL = 'https://www.fuzoku.jp/admin/login';
  protected PLATFORM_NAME = '風俗総合情報';
