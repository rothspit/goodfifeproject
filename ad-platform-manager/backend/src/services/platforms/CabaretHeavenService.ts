...
export class CabaretHeavenService extends BaseAdPlatformService {
  protected BASE_URL = 'https://cabaret-heaven.net/admin/';
  protected LOGIN_URL = 'https://cabaret-heaven.net/admin/login';
  protected PLATFORM_NAME = 'キャバクラヘブン';
