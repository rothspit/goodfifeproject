...
export class FuzokuJohoService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.fuzoku-joho.net/admin/';
  protected LOGIN_URL = 'https://www.fuzoku-joho.net/admin/login';
  protected PLATFORM_NAME = '風俗情報局';
