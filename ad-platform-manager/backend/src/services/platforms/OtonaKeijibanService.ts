...
export class OtonaKeijibanService extends BaseAdPlatformService {
  protected BASE_URL = 'https://otona-keijiban.com/admin/';
  protected LOGIN_URL = 'https://otona-keijiban.com/admin/login';
  protected PLATFORM_NAME = 'おとなの掲示板';
