...
export class PocchariChService extends BaseAdPlatformService {
  protected BASE_URL = 'https://www.pocchari-ch.com/admin/';
  protected LOGIN_URL = 'https://www.pocchari-ch.com/admin/login';
  protected PLATFORM_NAME = 'ぽっちゃりChannel';
