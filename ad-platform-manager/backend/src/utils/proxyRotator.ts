...
export class ProxyRotator {
   ...
   */
  private getFreeProxies(): ProxyConfig[] {
    return [
      // 実際の無料プロキシは頻繁に変わるため、
   ...
   */
  formatForPlaywright(proxy: ProxyConfig): { server: string; username?: string; password?: string } {
    return {
      server: proxy.server,
