...
exports.PinkCompanionService = void 0;
/**
 * ピンクコンパニオン 自動更新サービス
 * https://www.pinkcompanion.com/admin/
 * 優先度: medium
 */
const BaseAdPlatformService_1 = require("./BaseAdPlatformService");
class PinkCompanionService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.pinkcompanion.com/admin/';
        this.LOGIN_URL = 'https://www.pinkcompanion.com/admin/login';
        this.PLATFORM_NAME = 'ピンクコンパニオン';
    }
    /**
     * ログイン処理
     */
...
exports.PinkCompanionService = PinkCompanionService;
//# sourceMappingURL=PinkCompanionService.js.map