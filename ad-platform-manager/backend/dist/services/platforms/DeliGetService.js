...
class DeliGetService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.deli-get.com/admin/';
        this.LOGIN_URL = 'https://www.deli-get.com/admin/login';
        this.PLATFORM_NAME = 'デリゲット';
    }
    /**
     * ログイン処理
     */
...
exports.DeliGetService = DeliGetService;
//# sourceMappingURL=DeliGetService.js.map