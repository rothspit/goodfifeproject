...
exports.OtonaKeijibanService = void 0;
/**
 * おとなの掲示板 自動更新サービス
...
class OtonaKeijibanService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://otona-keijiban.com/admin/';
        this.LOGIN_URL = 'https://otona-keijiban.com/admin/login';
        this.PLATFORM_NAME = 'おとなの掲示板';
    }
    /**
     * ログイン処理
     */
...
exports.OtonaKeijibanService = OtonaKeijibanService;
//# sourceMappingURL=OtonaKeijibanService.js.map