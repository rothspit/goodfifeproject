...
exports.heavenNetService = exports.HeavenNetService = void 0;
/**
 * シティヘブンネット 自動更新サービス
...
class HeavenNetService {
    constructor() {
        ...
        this.BASE_URL = 'https://spmanager.cityheaven.net/';
        this.LOGIN_URL = 'https://spmanager.cityheaven.net/';
    }
    /**
     * ブラウザを初期化
     */
     ...
     * この実装は基本構造のみ
     */
    async postDiary(castId, title, content, images) {
        try {
            if (!this.isLoggedIn || !this.page) {
                throw new Error('Not logged in');
            }
...
exports.HeavenNetService = HeavenNetService;
// シングルトンインスタンスをエクスポート
exports.heavenNetService = new HeavenNetService();
//# sourceMappingURL=HeavenNetService.js.map