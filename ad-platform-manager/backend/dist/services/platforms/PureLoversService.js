...
exports.PureLoversService = void 0;
/**
 * ぴゅあらば 自動更新サービス
...
class PureLoversService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.purelovers.com/admin/';
        this.LOGIN_URL = 'https://www.purelovers.com/admin/login';
        this.PLATFORM_NAME = 'ぴゅあらば';
    }
    /**
     * ログイン処理
     */
...
exports.PureLoversService = PureLoversService;
//# sourceMappingURL=PureLoversService.js.map