...
exports.TeleClubService = void 0;
/**
 * 風俗テレクラ情報 自動更新サービス
...
class TeleClubService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://tele-club.net/admin/';
        this.LOGIN_URL = 'https://tele-club.net/admin/login';
        this.PLATFORM_NAME = '風俗テレクラ情報';
    }
    /**
     * ログイン処理
     */
...
exports.TeleClubService = TeleClubService;
//# sourceMappingURL=TeleClubService.js.map