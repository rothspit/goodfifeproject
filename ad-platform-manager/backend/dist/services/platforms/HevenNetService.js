...
exports.hevenNetService = exports.HevenNetService = void 0;
/**
 * ヘブンネット 自動更新サービス
 * シティヘブンネットと類似の構造
 */
const playwright_1 = require("playwright");
class HevenNetService {
    constructor() {
        this.browser = null;
        this.context = null;
        this.page = null;
        ...
        // ヘブンネットの管理画面URL（要調査）
        this.BASE_URL = 'https://www.heaven-net.jp/';
        this.MANAGER_URL = 'https://manager.heaven-net.jp/'; // 推測
    }
    /**
     * ブラウザを初期化
     */
...
exports.HevenNetService = HevenNetService;
exports.hevenNetService = new HevenNetService();
//# sourceMappingURL=HevenNetService.js.map