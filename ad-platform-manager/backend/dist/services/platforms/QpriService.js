...
exports.QpriService = void 0;
/**
 * Qプリ 自動更新サービス
 * https://www.qpri.jp/admin/
 * 優先度: medium
 */
const BaseAdPlatformService_1 = require("./BaseAdPlatformService");
class QpriService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.qpri.jp/admin/';
        this.LOGIN_URL = 'https://www.qpri.jp/admin/login';
        this.PLATFORM_NAME = 'Qプリ';
    }
    /**
     * ログイン処理
     */
...
exports.QpriService = QpriService;
//# sourceMappingURL=QpriService.js.map