...
exports.OtonaKeijiban = OtonaKeijiban;
Service;
BaseAdPlatformService_1.BaseAdPlatformService;
{
    BASE_URL = 'https://otona-keijiban.com/admin/';
    LOGIN_URL = 'https://otona-keijiban.com/admin/login';
    PLATFORM_NAME = 'おとなの掲示板';
    /**
     * ログイン処理
     */
    async;
    login(credentials, BaseAdPlatformService_1.PlatformCredentials);
    Promise < boolean > {
     ...
     */
    async;
    postDiary(diaryData, BaseAdPlatformService_1.DiaryPostData);
    Promise < boolean > {
        try: {
            : .isLoggedIn || !this.page
        }
    };
    {
...
//# sourceMappingURL=OtonaKeijiban%20Service.js.map