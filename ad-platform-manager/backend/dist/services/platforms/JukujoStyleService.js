...
exports.JukujoStyleService = void 0;
/**
 * 熟女Style 自動更新サービス
...
class JukujoStyleService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://jukujo-style.jp/admin/';
        this.LOGIN_URL = 'https://jukujo-style.jp/admin/login';
        this.PLATFORM_NAME = '熟女Style';
    }
    /**
     * ログイン処理
     */
...
exports.JukujoStyleService = JukujoStyleService;
//# sourceMappingURL=JukujoStyleService.js.map