...
exports.FuzokuInfoService = void 0;
/**
 * 風俗総合情報 自動更新サービス
...
class FuzokuInfoService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.fuzoku.jp/admin/';
        this.LOGIN_URL = 'https://www.fuzoku.jp/admin/login';
        this.PLATFORM_NAME = '風俗総合情報';
    }
    /**
     * ログイン処理
     */
...
exports.FuzokuInfoService = FuzokuInfoService;
//# sourceMappingURL=FuzokuInfoService.js.map