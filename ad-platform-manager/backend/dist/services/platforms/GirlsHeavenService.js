...
exports.GirlsHeavenService = void 0;
/**
 * ガールズヘブンネット 自動更新サービス
...
class GirlsHeavenService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://girls-heaven.jp/admin/';
        this.LOGIN_URL = 'https://girls-heaven.jp/admin/login';
        this.PLATFORM_NAME = 'ガールズヘブンネット';
    }
    /**
     * ログイン処理
     */
...
exports.GirlsHeavenService = GirlsHeavenService;
//# sourceMappingURL=GirlsHeavenService.js.map