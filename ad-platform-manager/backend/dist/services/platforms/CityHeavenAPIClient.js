...
exports.CityHeavenAPIClient = void 0;
/**
...
class CityHeavenAPIClient {
    constructor() {
        ...
        this.BASE_URL = 'https://spmanager.cityheaven.net/api/v1';
        this.WEB_BASE_URL = 'https://spmanager.cityheaven.net';
    ...
    async login(credentials) {
        try {
            ...
            const webResponse = await axios_1.default.post(`${this.WEB_BASE_URL}/login`, new URLSearchParams({
                username: credentials.username,
                password: credentials.password,
            }), {
                headers: {
    ...
    async postDiary(diaryData) {
        try {
            ...
            const webResponse = await axios_1.default.post(`${this.WEB_BASE_URL}/H8KeitaiDiaryEdit.php`, formData, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
...
exports.CityHeavenAPIClient = CityHeavenAPIClient;
//# sourceMappingURL=CityHeavenAPIClient.js.map