...
exports.CabaretHeavenService = void 0;
/**
 * キャバクラヘブン 自動更新サービス
...
class CabaretHeavenService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://cabaret-heaven.net/admin/';
        this.LOGIN_URL = 'https://cabaret-heaven.net/admin/login';
        this.PLATFORM_NAME = 'キャバクラヘブン';
    }
    /**
     * ログイン処理
     */
...
exports.CabaretHeavenService = CabaretHeavenService;
//# sourceMappingURL=CabaretHeavenService.js.map