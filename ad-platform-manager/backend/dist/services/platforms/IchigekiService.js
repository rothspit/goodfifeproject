...
exports.IchigekiService = void 0;
/**
 * 一撃 自動更新サービス
...
class IchigekiService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://www.ichigeki.jp/admin/';
        this.LOGIN_URL = 'https://www.ichigeki.jp/admin/login';
        this.PLATFORM_NAME = '一撃';
    }
    /**
     * ログイン処理
     */
...
exports.IchigekiService = IchigekiService;
//# sourceMappingURL=IchigekiService.js.map