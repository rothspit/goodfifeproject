...
exports.HeavenNetCCService = void 0;
/**
 * ヘブンネット (heavennet.cc) 自動更新サービス
 * シティヘブンネットと同様の構造を持つため、HeavenNetServiceを基盤として実装
 */
const playwright_1 = require("playwright");
class HeavenNetCCService {
    constructor() {
        this.browser = null;
        this.context = null;
        this.page = null;
        this.isLoggedIn = false;
        this.BASE_URL = 'https://www.heavennet.cc/admin/';
        this.LOGIN_URL = 'https://www.heavennet.cc/admin/login.php';
    }
    /**
     * ブラウザを初期化
     */
...
exports.HeavenNetCCService = HeavenNetCCService;
//# sourceMappingURL=HeavenNetCCService.js.map