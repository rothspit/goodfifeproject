...
class PinsaroService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://pinsaro.com/admin/';
        this.LOGIN_URL = 'https://pinsaro.com/admin/login';
        this.PLATFORM_NAME = 'ピンサロドットコム';
    }
    /**
     * ログイン処理
     */
...
exports.PinsaroService = PinsaroService;
//# sourceMappingURL=PinsaroService.js.map