...
exports.EkichikaService = void 0;
/**
 * 駅ちか 自動更新サービス
 * https://ekichika.jp/admin/
 * 優先度: high
 */
const BaseAdPlatformService_1 = require("./BaseAdPlatformService");
class EkichikaService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://ekichika.jp/admin/';
        this.LOGIN_URL = 'https://ekichika.jp/admin/login';
        this.PLATFORM_NAME = '駅ちか';
    }
    /**
     * ログイン処理
     */
...
exports.EkichikaService = EkichikaService;
//# sourceMappingURL=EkichikaService.js.map