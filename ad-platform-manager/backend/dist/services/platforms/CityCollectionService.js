...
exports.CityCollectionService = void 0;
/**
 * シティコレクション 自動更新サービス
...
class CityCollectionService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://city-collection.net/admin/';
        this.LOGIN_URL = 'https://city-collection.net/admin/login';
        this.PLATFORM_NAME = 'シティコレクション';
    }
    /**
     * ログイン処理
     */
...
exports.CityCollectionService = CityCollectionService;
//# sourceMappingURL=CityCollectionService.js.map