...
exports.BoysHeavenService = void 0;
/**
 * ボーイズヘブンネット 自動更新サービス
 * https://boys-heaven.jp/admin/
 * 優先度: low
 */
const BaseAdPlatformService_1 = require("./BaseAdPlatformService");
class BoysHeavenService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://boys-heaven.jp/admin/';
        this.LOGIN_URL = 'https://boys-heaven.jp/admin/login';
        this.PLATFORM_NAME = 'ボーイズヘブンネット';
    }
    /**
     * ログイン処理
     */
...
exports.BoysHeavenService = BoysHeavenService;
//# sourceMappingURL=BoysHeavenService.js.map