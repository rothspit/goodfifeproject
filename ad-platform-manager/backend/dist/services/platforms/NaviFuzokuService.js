...
exports.NaviFuzokuService = void 0;
/**
...
class NaviFuzokuService extends BaseAdPlatformService_1.BaseAdPlatformService {
    constructor() {
        super(...arguments);
        this.BASE_URL = 'https://navi-fuzoku.com/admin/';
        this.LOGIN_URL = 'https://navi-fuzoku.com/admin/login';
        this.PLATFORM_NAME = 'Navi Fuzoku';
    }
    /**
     * ログイン処理
     */
...
exports.NaviFuzokuService = NaviFuzokuService;
//# sourceMappingURL=NaviFuzokuService.js.map